...
@Mike: I'm just curious, why did you choose to take a `substring` of the transcript names? I didn't do this because I feel its easier to have the same name format in the results as in the original `RangedSummarizedExperiment` object.
